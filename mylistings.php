...
<ul class="list-group">
    ...
    $query_sql = <<<SQL
select *, (select count(*) from "Bid" where "Bid".itemid = "Items".itemid) as bids from "Items" where userID = $userID order by listingdate desc limit $results_per_page offset {$offset}
SQL;
